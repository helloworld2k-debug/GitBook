...
export default async function LoginPage({ params, searchParams }: LoginPageProps) {
  ...
  const messages: LoginFormMessages = {
    ...
    accountExistsError: t("accountExistsError"),
    ...
    registrationCheckInboxAction: t("registrationCheckInboxAction"),
    registrationEmailSentTitle: t("registrationEmailSentTitle"),
    registrationImmediateSuccess: t("registrationImmediateSuccess"),
    registrationNextSteps: [
      t("registrationNextStepOpen"),
      t("registrationNextStepSpam"),
      t("registrationNextStepExpiry"),
    ],
    ...
    resendConfirmationRateLimited: t("resendConfirmationRateLimited"),
    resendConfirmationSent: t("resendConfirmationSent"),
