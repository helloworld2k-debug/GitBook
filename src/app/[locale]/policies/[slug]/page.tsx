  ...
  return (
    <main className="bg-white">
      <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:py-20">
        <p className="text-sm font-semibold uppercase tracking-normal text-cyan-700">{t("eyebrow")}</p>
        ...
        {page.updated_at ? (
          <p className="mt-3 text-sm text-slate-500">
            {t("lastUpdated")} {new Intl.DateTimeFormat("en", { dateStyle: "medium", timeZone: "UTC" }).format(new Date(page.updated_at))}
          </p>
        ) : null}
