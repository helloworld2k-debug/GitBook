...
export const seedNewsArticles: SeedNewsArticle[] = [
  {
    slug: "vision-foundation-models-enter-the-field",
    title: "Vision Foundation Models Enter the Field",
    summary: "AI-generated visual systems are moving from lab demos into practical field workflows for inspection, research, and design.",
    topic: "vision foundation models",
    coverImagePath: "/news/vision-foundation-models-enter-the-field.webp",
    imageAlt: "AI generated abstract field of visual model nodes and glowing camera grids",
    publishedAt: "2026-05-03T09:00:00.000Z",
    body: `Vision foundation models are becoming the connective tissue between cameras, sensors, and expert decision workflows. Instead of training one narrow recognizer at a time, teams can now start with broad visual representations and adapt them to new environments with less labeled data.
...
This article is AI-created promotional content about emerging AI and visual recognition trends.`,
  ...
  {
    slug: "multimodal-perception-reshapes-interfaces",
    title: "Multimodal Perception Reshapes Interfaces",
    summary: "AI systems that read images, text, and spatial context together are changing how people interact with technical information.",
    topic: "multimodal perception",
    coverImagePath: "/news/multimodal-perception-reshapes-interfaces.webp",
    imageAlt: "AI generated multimodal interface with image panels text vectors and perception streams",
    publishedAt: "2026-04-24T09:00:00.000Z",
    body: `The next generation of visual recognition is less isolated and more conversational. Multimodal systems can combine an image, a prompt, a diagram, and a user goal into one reasoning loop.
...
This article is AI-created promotional content about emerging AI and visual recognition trends.`,
  ...
  {
    slug: "medical-image-recognition-enters-a-careful-new-phase",
    title: "Medical Image Recognition Enters a Careful New Phase",
    summary: "AI-assisted imaging is advancing toward better triage, measurement, and quality control while keeping clinical review central.",
    topic: "medical image recognition",
    coverImagePath: "/news/medical-image-recognition-enters-a-careful-new-phase.webp",
    imageAlt: "AI generated medical imaging workstation with neural overlays and diagnostic scan panels",
    publishedAt: "2026-04-11T09:00:00.000Z",
    body: `Medical visual recognition is moving from novelty toward disciplined assistance. The best use cases focus on measurable support: highlighting regions, tracking change, checking image quality, and prioritizing review.
...
This article is AI-created promotional content about emerging AI and visual recognition trends.`,
  ...
  {
    slug: "edge-vision-ai-moves-closer-to-real-time-decisions",
    title: "Edge Vision AI Moves Closer to Real-Time Decisions",
    summary: "Compact recognition models are bringing faster visual decisions to devices, machines, and field equipment.",
    topic: "edge vision AI",
    coverImagePath: "/news/edge-vision-ai-moves-closer-to-real-time-decisions.webp",
    imageAlt: "AI generated edge device processing live camera signals with luminous circuit patterns",
    publishedAt: "2026-03-28T09:00:00.000Z",
    body: `Visual recognition is increasingly happening near the camera instead of only in the cloud. Edge AI reduces latency, keeps sensitive images closer to the source, and supports systems that need immediate feedback.
...
This article is AI-created promotional content about emerging AI and visual recognition trends.`,
  ...
  {
    slug: "robotics-scene-understanding-gets-more-contextual",
    title: "Robotics Scene Understanding Gets More Contextual",
    summary: "Robotic perception is becoming more useful as AI models learn relationships between objects, spaces, and intended actions.",
    topic: "robotics scene understanding",
    coverImagePath: "/news/robotics-scene-understanding-gets-more-contextual.webp",
    imageAlt: "AI generated robot vision scene with depth grids object outlines and spatial reasoning trails",
    publishedAt: "2026-03-16T09:00:00.000Z",
    body: `Robots need more than object labels. They need to understand where objects are, how they relate, what can move, and which visual cues matter for the next action.
...
This article is AI-created promotional content about emerging AI and visual recognition trends.`,
  ...
  {
    slug: "explainable-visual-recognition-builds-trust",
    title: "Explainable Visual Recognition Builds Trust",
    summary: "As vision systems enter higher-stakes workflows, teams need clearer explanations of what the model saw and why it responded.",
    topic: "explainable visual recognition",
    coverImagePath: "/news/explainable-visual-recognition-builds-trust.webp",
    imageAlt: "AI generated explainable vision dashboard with highlighted image regions and confidence paths",
    publishedAt: "2026-03-02T09:00:00.000Z",
    body: `Accuracy is only part of the story for visual recognition. When a model flags a defect, a risk, or an unusual pattern, people need to know what visual evidence influenced that result.
...
This article is AI-created promotional content about emerging AI and visual recognition trends.`,
  ...
  {
    slug: "synthetic-data-expands-vision-testing",
    title: "Synthetic Data Expands Vision Testing",
    summary: "AI-generated images are becoming a practical way to explore rare conditions and strengthen visual recognition workflows.",
    topic: "synthetic data for vision systems",
    coverImagePath: "/news/synthetic-data-expands-vision-testing.webp",
    imageAlt: "AI generated synthetic data factory with image tiles variations and model evaluation grids",
    publishedAt: "2026-02-22T09:00:00.000Z",
    body: `Real-world image collection is expensive, uneven, and often incomplete. Synthetic data gives teams another way to explore visual situations that are rare, sensitive, or difficult to stage.
...
This article is AI-created promotional content about emerging AI and visual recognition trends.`,
  ...
  {
    slug: "satellite-vision-ai-tracks-changing-earth-systems",
    title: "Satellite Vision AI Tracks Changing Earth Systems",
    summary: "AI-assisted satellite recognition is helping teams monitor environmental change, infrastructure, and large-scale visual signals.",
    topic: "satellite and climate vision AI",
    coverImagePath: "/news/satellite-vision-ai-tracks-changing-earth-systems.webp",
    imageAlt: "AI generated satellite earth observation image with climate overlays and recognition grids",
    publishedAt: "2026-02-14T09:00:00.000Z",
    body: `Satellite imagery creates a visual record at planetary scale. AI recognition can help turn that record into timely signals about land use, water, vegetation, infrastructure, and climate stress.
...
This article is AI-created promotional content about emerging AI and visual recognition trends.`,
  ...
  {
    slug: "industrial-inspection-ai-learns-the-small-signals",
    title: "Industrial Inspection AI Learns the Small Signals",
    summary: "Computer vision is improving the detection of subtle defects, process drift, and quality signals in production environments.",
    topic: "industrial inspection AI",
    coverImagePath: "/news/industrial-inspection-ai-learns-the-small-signals.webp",
    imageAlt: "AI generated industrial inspection line with micro defect highlights and sensor overlays",
    publishedAt: "2026-02-06T09:00:00.000Z",
    body: `Industrial inspection depends on small visual signals. A scratch, color shift, alignment issue, or surface texture change can indicate a process that needs attention.
...
This article is AI-created promotional content about emerging AI and visual recognition trends.`,
  ...
  {
    slug: "scientific-imaging-discovers-hidden-patterns",
    title: "Scientific Imaging Discovers Hidden Patterns",
    summary: "AI-supported visual analysis is helping researchers explore microscopy, materials, and instrument imagery with fresh attention.",
    topic: "scientific imaging and discovery",
    coverImagePath: "/news/scientific-imaging-discovers-hidden-patterns.webp",
    imageAlt: "AI generated scientific imaging visualization with microscopy patterns and neural analysis overlays",
    publishedAt: "2026-02-01T09:00:00.000Z",
    body: `Scientific instruments produce images that are dense with structure. Microscopy, materials scans, lab imaging, and experimental video can contain patterns that are difficult to inspect manually at scale.
