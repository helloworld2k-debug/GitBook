-- Update cloud sync entitlement calculation from days to calendar months
-- Using Beijing timezone (Asia/Shanghai) for month-based calculations
-- This fixes a parameter mismatch issue where code passes input_months
-- but the RPC function expects input_days
